...
function Contact() {
    ...
    const validateForm = () => {
        ...
        if (!nameRegex.test(nom)) errors.nom = 'Le nom ne doit contenir que des lettres.';
        if (!nameRegex.test(prenom)) errors.prenom = 'Le prénom ne doit contenir que des lettres.';
