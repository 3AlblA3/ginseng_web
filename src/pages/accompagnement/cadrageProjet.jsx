...
import './cadrageProjet.css'

function CadrageProjet () {
    return(
        <>
        <section className='banner'>
            <h4>Avant le projet</h4>
            <h2>Cadrage du projet : arborescence, gabarits et contenus : donner forme à votre projet</h2>
        </section>
        <section className='content__block'>
            ...
            <h3>L’importance de l’arborescence pour structurer votre site web</h3>
            <p>L’arborescence, c’est l’ossature de votre site. Elle permet d’organiser vos contenus de manière fluide et intuitive pour vos utilisateurs. Le menu est le point d'entrée principal, le guide qui dévoile les différentes sections du site. Les utilisateurs s'appuient sur cette architecture pour s'orienter, découvrir vos contenus, et interagir avec ce que vous proposez.</p>
