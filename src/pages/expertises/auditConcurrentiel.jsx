    ...
    return(
        ...
        <section className='content__block__row'>
            ...
            <article className='content__block__row__container__text'>
                ...
                <p>L’audit peut être complété, dans un second temps, par la réalisation de gabarits ergonomiques afin de mettre en place l’ensemble des préconisations faites. Cela fait partie aussi de la méthodologie mise en place dans l’accompagnement de projet web par Netemedia.</p>
            </article>
        </section>
        <section className='content__block__row'>
